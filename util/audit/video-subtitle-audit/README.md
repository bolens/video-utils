# video-subtitle-audit

List subtitle streams and language tags.

Mode: **read**. Operation: `subtitle-audit`.
...
```bash
bin/video-utils video-subtitle-audit --help
```
...
```text
usage: video-subtitle-audit [-h] [--config CONFIG] [--apply] [-n] [-j JOBS]
