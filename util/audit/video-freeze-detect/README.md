...
Detect frozen picture intervals.

Mode: **read**. Operation: `freeze-detect`.
...
```bash
bin/video-utils video-freeze-detect --help
```
...
```text
usage: video-freeze-detect [-h] [--config CONFIG] [--apply] [-n] [-j JOBS]
